...
서포트, 카터필러롤, 트레이보X 등이 있으며, 이 제품들은 3인용 소파, 의자, 리클라이너, 침대로도 활용 가능해. 또한, 최근에는 요기보 슬림, 드롭, 라운저, 소형 소파인 요기보 미니와 피라미드도 출시되었어.
요기보의 대표 커버는 부드럽고 신축성 있는 특수소재로 제작되어, 고무보다 3~4배 더 단단한 내구성을 자랑하며, 수십 가지 이상의 컬러
옵션을 통해 계절과 공간에 맞는 홈스타일링을 가능하게 해. 기존 소파와 달리, 요기보 소파는 커버를 분리하여 세탁할 수 있어 관리가 용이하고, 가벼워 이동 및 보관이 간편해.
또한, 아웃도어 제품 라인인 줄라(Zoola) 커버는 생활방수와 자외선 차단 기능을 제공하여 캠핑, 카페, 수영장 등 야외 활동에 적합해. 
요기보는 바디필로우, 쿠션, 아로마테라피, 캐릭터 인형 등 힐링과 휴식을 위한 다양한 제품도 제조 및 판매하고 있어.
빈백 소파의 충전재는 일반 솜이 아닌 '비즈(Beads)'를 사용하며, 스탠다드, 프리미엄, 프리미엄 플러스 총 3가지 종류가 있어. 이 비즈는 
