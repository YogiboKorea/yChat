...
/**
 * 챗봇 메인 로직 함수 – 주문번호가 포함된 경우 배송 상태 확인 부분 수정
 */
  ...
  if (containsOrderNumber(normalizedUserInput)) {
    if (memberId && memberId !== "null") {
      try {
        ...
        // 예를 들어, shipmentInfo.shipments가 존재한다고 가정합니다.
