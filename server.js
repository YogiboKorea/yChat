    ...
    if (memberId && memberId !== "null") {
      try {
        ...
        if (orderData.orders && orderData.orders.length > 0) {
          ...
          return { 
            text: `배송은 제품 출고 후 1~3 영업일 정도 소요되며,
            제품별 출고 시 소요되는 기간은 아래 내용을 확인해주세요. <br/>
            
            - 소파 및 바디필로우: 주문 확인 후 제작되는 제품으로, 3~7 영업일 이내에 출고됩니다.<br/>
            - 모듀(모듈러) 소파: 주문 확인일로부터 1~3 영업일 이내에 출고됩니다.<br/>
            - 그 외 제품: 주문 확인일로부터 1~3 영업일 이내에 출고됩니다.<br/>
